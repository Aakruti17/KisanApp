...
<div style="padding-left:0px">
  <center><h2 style="color:green">KISAN</h2></center>
	...
	%>
		...
		<h4 style="color:green"> News/Notification Updated Successfully!</h4>
	...
	<h4 style="color:red"> Error!  News/Notification Not Added</h4>
...
<fieldset style="width:500px;margin-top:1%;background:#26E5B1;margin-left:29%">
	
		<center><h3> Update Latest News & Notifications </h3></center>
		<form action="./UpdateNewsServlet" method="post">
			News Contents: <br><textarea  name="ncontents" rows="7" cols="50" style="width:500px"> 
			
			</textarea><br><br>
			Date: <br><input type="text" name="ndate" style="width:500px;height:30px"> <br><br>
			News Type: <br>
			<select  style="width:500px;height:30px" name="ntype">
